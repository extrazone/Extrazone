...
BOT_TOKEN = environ.get('BOT_TOKEN', "5389249317:AAEN3i8Orf8wfU9XizROVFVZ9M5G6e4uc2E")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001225188740') #Channel / Group Id for force sub ( make sure bot is admin )
